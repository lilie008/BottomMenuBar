...
import widget.charts.entity.IMeasurable;
...
//					}
	...
	/** 
	 * @Description: 修正触点位置，使其在中点 
	 * @return void
	 */
	public void fixTouchPoint(){
		int index = getSelectedIndex() - displayFrom;
		float stickWidth = getDataQuadrantPaddingWidth() / displayNumber
				- stickSpacing;
		float stickX = getDataQuadrantPaddingStartX();

		touchPoint.x = stickX + index*(stickWidth + stickSpacing) + stickWidth/2;
	}
